...
{
    public static PathDebug Instance { get; private set; }
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                gridSnapshotAction.AddAction(() => {
                    ...
                    Color backgroundColor = new Color(99, 99, 99);
                    ...
                    if (isInOpenList)
                    {
                        backgroundColor = new Color(0, 154, 255);
                    }
                    if (isCurrent)
                    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                gridSnapshotAction.AddAction(() => {
                    ...
                    {
                        backgroundColor = new Color(99, 99, 99);
                    }
